          ...
          <main className="p-6" >
            ...
            <div className="flex justify-between items-center mb-6">
              <div className="flex w-full">
                <button 
                  className={`flex-1 text-center px-4 py-2 font-medium ${activeTab === 'dashboard' ? 'text-indigo-600 border-b-2 border-indigo-600' : 'text-gray-600 hover:text-gray-900'}`}
                  onClick={() => setActiveTab('dashboard')}
                >
                  Dashboard
                </button>
                <button 
                  className={`flex-1 text-center px-4 py-2 font-medium ${activeTab === 'expenses' ? 'text-indigo-600 border-b-2 border-indigo-600' : 'text-gray-600 hover:text-gray-900'}`}
                  onClick={() => setActiveTab('expenses')}
                >
                  Expenses
                </button>
                <button 
                  className={`flex-1 text-center px-4 py-2 font-medium ${activeTab === 'users' ? 'text-indigo-600 border-b-2 border-indigo-600' : 'text-gray-600 hover:text-gray-900'}`}
                  onClick={() => setActiveTab('users')}
                >
                  Users
                </button>
                <button 
                  className={`flex-1 text-center px-4 py-2 font-medium ${activeTab === 'companies' ? 'text-indigo-600 border-b-2 border-indigo-600' : 'text-gray-600 hover:text-gray-900'}`}
                  onClick={() => setActiveTab('companies')}
                >
                  Companies
                </button>
                <button 
                  className={`flex-1 text-center px-4 py-2 font-medium ${activeTab === 'settings' ? 'text-indigo-600 border-b-2 border-indigo-600' : 'text-gray-600 hover:text-gray-900'}`}
              ...
              {/* Notification bell remains on the side */}
